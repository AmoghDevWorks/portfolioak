  ...
  return (
    <div className='bg-customgrey max-w-screen h-fit p-6  flex items-center justify-center'>
        <div className='h-fit p-1 md:p-4 md:w-2/3 shadow-custom rounded-lg text-white'>
            ...
            <p className='my-3 leading-7 lg:leading-10 text-lg md:text-2xl px-4 text-left md:text-justify'>&nbsp;&nbsp;&nbsp;&nbsp;With a strong foundation in <b>Data Structures & Algorithms</b> (<b>400+ LeetCode problems solved</b>) and a <b>CodeChef rating of 1498</b>, I enjoy tackling complex problems and optimizing solutions.</p>
